...
train = pd.read_csv('C:/Users/gsravyasree/Documents/innovation/train.csv')
train_original=train.copy()
test = pd.read_csv('C:/Users/gsravyasree/Documents/innovation/test.csv')
...
def convert_emoticons(combine):
    for emot in EMOTICONS:
        combine['Tidy_Tweets'] = re.sub(u'('+emot+')', "_".join(EMOTICONS[emot].replace(",","").split()), combine['Tidy_Tweets'])
    return combine['Tidy_Tweets']


def convert_emojis(ombine):
    for emot in UNICODE_EMO:
        combine['Tidy_Tweets']= re.sub(r'('+emot+')', "_".join(UNICODE_EMO[emot].replace(",","").replace(":","").split()), combine['Tidy_Tweets'])
    return combine['Tidy_Tweets']



combine['Tidy_Tweets'] = combine['Tidy_Tweets'].str.replace("[^a-zA-Z#]", " ")
#combine['Tidy_Tweets'] = combine['Tidy_Tweets'].str
...
tokenized_tweet = [word for word in tokenized_tweet if word not in stopwords.words('english')]
...
train_bow.todense()
train_tfidf_matrix = tfidf_matrix[:31964]
...
submission.to_csv('C:/Users/gsravyasree/Documents/innovation/result.csv', index=False)
result= pd.read_csv('C:/Users/gsravyasree/Documents/innovation/result.csv')
print("total", len(result),"got processed")
